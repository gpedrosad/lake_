...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:ml-36 xs:items-center md:items-start justify-center">
        ...
        <p className="text-white text-xl md:text-md xl:text-xl">(07) 4095 3847</p>
        <p className="text-white mb-10 text-xl md:text-md xl:text-xl">info@lakebarrine.com.au</p>
        <span className="text-white text-xl md:text-md xl:text-xl text-center md:text-left">Lake Barrine</span>
        <span className="text-white text-xl md:text-md xl:text-xl ml-5 mr-5 text-center md:text-left md:ml-0 md:mr-0">Gillies Highway, <br></br>Yungaburra Queensland 4884</span>
    </div>
