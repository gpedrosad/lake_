  ...
  return (
    <div className="relative overflow-hidden shadow-lg w-auto h-[700px] sm:h-[600px]">
      ...
      <div className="absolute inset-0 z-10 p-6 flex items-center justify-center">
        <img src={hojablanca1} alt="Descripción de la imagen" style={{ width: '60px', height: '60px' }} className="m-5 mb-40 md:mb-40 xl:mb-48 2xl:mb-40"/>
        <h1 className="text-white md:text-5xl sm:text-4xl font-rufina font-bold text-center mt-14 xl:mt-4 xs:text-4xl">
          Explore the rainforest in a walk of 5 km around the lake
        <Link to='/accomodation'>
        <div className="flex justify-center pt-20">
          <YellowButton text="Book"/>
        </div>
        </Link>
        </h1>
        <img src={hojablanca2} alt="Descripción de la imagen" style={{ width: '50px', height: '50px' }} className="m-5 mb-40 xl:mb-48 2xl:mb-36"/>
      </div>
      <div>
      </div>
    </div>
