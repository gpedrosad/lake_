...
const ImageText = () => {
  return (
    <div className="sm:mb-36 md:mb-0">
      <h1 className="whitespace-nowrap text-custom-green font-rufina font-bold py-4 xl:text-5xl 2xl:text-5xl sm:text-xl md:text-3xl lg:text-3xl xs:text-2xl text-center">Where moments become <br></br><span class="text-yellow-500 whitespace-nowrap">unforgettable memories</span></h1>
