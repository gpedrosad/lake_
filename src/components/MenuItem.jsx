  ...
  return (
    <div className="flex flex-col items-center bg-white shadow-md rounded-lg p-4 m-2">
      <div className="w-full p-4 flex flex-col md:flex-row md:items-center md:justify-center md:space-x-4">
        ...
        <p className="text-4xl font-rufina font-bold text-gray-800 mt-4 md:mt-0 text-center custom-green">{precio}</p>
      </div>
      {modalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-4 rounded-lg shadow-lg mx-auto max-w-lg md:max-w-2xl text-center">
