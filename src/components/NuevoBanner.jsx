...
const NuevoBanner = () => {
  ...
  <div className="flex justify-center items-center lg:col-start-1 lg:col-span-6 lg:row-start-1 lg:row-span-2 lg:mb-40 mt-10 lg:mt-0">
    <img src={nalita2} className="shadow-none" />
  </div>
...
<div className="lg:col-start-6 lg:col-span-4 lg:row-start-1 lg:row-span-1 lg:mt-40 relative">
  <div className="flex items-center justify-center mb-10 space-x-1">
    ...
    <h1 className="p-10 font-rufina font-bold text-2xl text-third-green md:text-4xl lg:text-5xl text-center">Where the Rainforest meets the Lake</h1>
  ...
  <p className="font-inika font-normal text-xl md:text-2xl lg:text-3xl mt-5 p-20 lg:p-0">
