  ...
  return (
    <>
      <div className="bg-[#F7F7F7] grid grid-cols-1 md:grid-cols-2 gap-3 p-4 justify-items-center items-center pt-16">
        ...
        <img src={teaPhoto} alt="foto" className="w-full md:w-full h-5/6 object-contain" />
        
        <div className="items-center px-10 py-5 md:mb-20">
  <h1 className="text-center whitespace-nowrap font-rufina pb-3 mb-1 mt-6 font-bold text-third-green text-3xl sm:text-3xl md:text-3xl md:pb-5 md:pt-10 sm:pb-3 sm:pt-11 sm:mb-1 xl:text-5xl">
    Restaurant
  </h1>
  <div className="space-y-6">
    <p className="text-center text-xl text-custom-green xl:text-2xl">
