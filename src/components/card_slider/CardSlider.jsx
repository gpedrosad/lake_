    ...
    <div className="slider-component">
      ...
      <div className="slider-container" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
        ...
        <div className="slider-wrapper" ref={sliderRef} style={{ transform: `translateX(-${currentIndex * (100 / itemsToShow)}%)` }}>
          <Card title="Restaurant" description="A good meal always starts with an appetite. Nestled within the embrace of the rainforest, our family-run business invites you to gather around our tables and experience the warmth and comfort of homemade food." image={cardimg1} textButton='Discover Restaurant' />
          <Card title="Boat cruise" description="Let us sweep you away on a gentle journey across the calm waters of Lake Barrine. A time of simple elegance, where nature's beauty and the company of loved ones create unforgettable memories." image={cardimg2} textButton='Discover Boat' />
          <Card title="Functions" description="Not a day goes by where we don’t meet someone who shares a memory of a time long ago celebrated at Lake Barrine. The historic Teahouse and the setting of the sun across the water naturally lend themselves to the most special of occasions." image={cardimg3} textButton='Discover Functions'/>
          <Card title="Accommodation" description="Step inside and experience the beauty and tranquillity of our lakeside lodge. Whether you're seeking adventure or a moment of quiet reflection, our accommodation provides the perfect base for your exploration." image={cardimg4} textButton='Discover Accommodation' />
        </div>
